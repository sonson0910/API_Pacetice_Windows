// ThucHanh.cpp : Defines the entry point for the application.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_THUCHANH, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_THUCHANH));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_THUCHANH));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, TEXT("Nguyễn Hồng Sơn - 211204228"), WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_LBUTTONUP:
        ...
        break;
    case WM_CLOSE:
        if (MessageBox(NULL, TEXT("Bạn có muốn thoát không?"), TEXT("Notification"), MB_YESNO | MB_ICONQUESTION) == IDYES) {
            PostQuitMessage(0); 
        }
        break;
